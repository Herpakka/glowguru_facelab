# continue from A, this is complete both forehead and both cheeks
        ...
        with mp_face_mesh.FaceMesh(
            ...
            if results.multi_face_landmarks:
                ...
                if mode == "show":
                    ...
                    chk_oil_all, chk_oil_max, chk_img3,chk_edge = oil_area(chk_img)
    ...
    if mode == "show":
        ...
        for i in classes:
            ...
            for j in glob.glob(src1):
                apply_clahe(j,"write") #mark oil/51.jpg
                # print(i)

run("show","svm/Train/oily/45.jpg") # dry/57.jpg เกิน 100% 5555